...
screen 1 do
  ...
  bottom     [ :views, :separator, :title, :spacer, :keychain, :spacer, :separator, :memory, :separator, :cpu, :separator, :pacman, :separator, :mpd, :separator, :fuzzytime, ]
...
grab "XF86AudioMedia", "/home/juliuss/bin/mpm"
grab "XF86AudioLowerVolume", "/home/juliuss/bin/volume -d 5"
grab "XF86AudioRaiseVolume", "/home/juliuss/bin/volume -i 5"
grab "XF86AudioMute", "/home/juliuss/bin/volume -t"
...
view "one" do
  match "terms|default"
  icon "/home/juliuss/.local/share/subtle/icons/terminal.xbm"
  icon_only true
end

view "two" do
  match "editor"
  icon "/home/juliuss/.local/share/subtle/icons/ghost.xbm"
  icon_only true
end

view "three" do
  match "browser"
  icon "/home/juliuss/.local/share/subtle/icons/fox.xbm"
  icon_only true
end

view "four" do
  match "gimp_.*|filem|chat"
  icon "/home/juliuss/.local/share/subtle/icons/paint.xbm"
  icon_only true
