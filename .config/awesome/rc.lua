...
globalkeys = awful.util.table.join(
	...
	awful.key({ }, "XF86Launch2", function () exec("/home/juliuss/bin/spegni", false) end),
	...
	-- MPD control
    awful.key({ modkey }, "XF86AudioPlay", function () exec("/home/juliuss/bin/mpd-toggle", false) end),
